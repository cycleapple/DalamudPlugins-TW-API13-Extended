...
| AutoRetainer | 4.5.1.26 | 雇員相關功能 | 已發布；新增探索載具主頁、航線／解鎖規劃器與多角色設定 zh-TW |
...
| Artisan | 4.0.4.12 | 生產輔助 | 已發布；補齊製作清單編輯器、配方視窗與材料表格 zh-TW |
...
| AutoDuty | 0.0.0.5 | 副本自動化框架 | 已發布 API13；補齊路徑編輯器、路徑管理與資訊／相依插件說明 zh-TW |
