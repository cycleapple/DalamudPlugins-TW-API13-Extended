...
| Artisan | 4.0.4.24 | 生產輔助 | 已發布；修正宇宙配方精確選取與逾時回報，IPC 僅在確認指定配方後啟動製作 |
...
| Ice's Cosmic Exploration | 0.0.73.51 | 宇宙探索採集、生產與任務輔助 | 已發布；新增安全的具名任務預設，並保留逾時成果、有限採集、Critical 繳交點與設定保存修正 |
