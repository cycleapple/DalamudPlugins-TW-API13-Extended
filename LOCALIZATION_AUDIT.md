...
| AutoRetainer | 第二輪完成 | 4.5.1.24；除第一輪外，補齊主視窗、免責聲明、工作階段狀態、統計、公會與金幣資料、通知、夜間模式、委託保管、多角色／登入／雇員／軍票浮層及重複執行警告；遊戲文字比對、Addon、Regex、IPC、指令、序列化與自動化流程未變更 |
...
| GatherBuddy Reborn | 第二輪完成 | 7.3.5.3；除第一輪外，補齊釣魚統計設定、釣場資訊、捕獲比例、鬧鐘提示、採集組時間、預設還原、記錄清理、魚類覆寫與多重提鉤介面；遊戲文字比對、採集資料、序列化、AutoHook IPC、導航與 DataId 未變更 |
| Artisan | 第一輪完成 | 4.0.4.10；完成 manifest、製作浮窗、耐久製作、巨集頁與製作清單入口／提示；RawInformation、Hotbars、技能／配方資料、遊戲文字比對、IPC、求解與自動化未變更 |
| AutoDuty | 第二輪完成 | 0.0.0.3；除第一輪外，補齊次級設定、循環插件／BMAI／vnavmesh 提示、循環間動作、裝備、修理、消耗品、寶箱、分解、軍票、九宮幻卡、AutoRetainer 整合與循環終止介面；指令 token、IPC、Addon、列舉／序列化值、路徑格式、導航判斷與自動化未變更 |
...
| Bossmod Reborn | 第一輪完成 | 7.3.8.3；完成核心設定、循環、模組檢視、隊伍職責與關於介面；戰鬥模組資料、ID、IPC 與功能流程未變更 |
...
| Sonar | 已完成第一輪 | 0.7.4.3；完成插件說明、一般／狩獵／FATE／顏色／聊天／音效設定、Lodestone 驗證與支援表單的 zh-TW 介面翻譯；網路協定、回報內容、設定鍵、列舉值、序列化欄位、IPC、命令與資料庫語言選擇均未修改 |
