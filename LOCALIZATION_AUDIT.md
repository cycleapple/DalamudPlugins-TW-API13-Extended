...
| Questionable | 已完成 | 13.68.129.6；完成任務優先順序、任務日誌、友好部族額度、單人任務戰鬥與 BossMod 相容性、進階設定、必要插件提示、採集日誌搜尋及 Quest Map／vnavmesh 使用者提示；開發者診斷文字保留原文。任務路徑、導航、IPC、指令、Excel ID、Addon、hook/signature 未變更 |
