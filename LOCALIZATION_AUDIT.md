...
| Ice's Cosmic Exploration | 已完成 | 0.0.73.42；完成 manifest、主側欄、模式選擇、停止條件、任務／職業優先序、信用點購物、宇宙轉盤、安全、採集設定、浮層、Waypoint、任務表／詳情／統計、必要插件與紀錄等一般使用者介面；任務／技能／物品資料、遊戲文字比對、IPC、ID、序列化、自動化與導航未變更 |
