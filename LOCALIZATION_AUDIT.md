...
| Lifestream | 已完成 | 2.5.3.7；完成核心設定、房屋路徑、Wotsit、浮層、通訊錄、Custom Alias 與 PaissaDB 介面；另修正台服八個世界的正確 ID、中文／英文名稱解析、陸行鳥資料中心分組與 Materia 誤列；指令 token、序列化與 PaissaDB 協定未變更 |
