...
| Artisan | 已完成 | 4.0.4.17；補齊耐久製作錯誤、消耗品預設狀態、模擬狀態／結果、技能不可用原因與巨集能力值提示；另修正台服「工匠的良機」狀態同步、過期推薦工作逾時及製作結束 Null 例外；保留與巨集解析共用的英文技能識別名稱，DebugTab、內部 ID、命令、IPC、序列化與遊戲資料未變更 |
