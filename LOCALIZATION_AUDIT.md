...
| Price Insight | 已完成 | 2.11.3.4；設定介面與市場佈告板物品說明繁中化；支援繁中服染料 Universalis v3 相容查詢及未收錄物品容錯 |
...
| Artisan | 已完成 | 4.0.4.25；既有 zh-TW 介面完整保留；新增安全暫時製作 IPC 與附近玩家巨集延遲的繁中設定／狀態文字。保留英文技能識別名稱、DebugTab、內部 ID、命令、既有序列化與遊戲資料 |
