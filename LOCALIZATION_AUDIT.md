...
| AutoRetainer | 第一輪完成 | 4.5.1.23；完成主要設定、快捷鍵、登入覆蓋層、雇員批次與探索載具介面；遊戲文字比對、Addon、Regex、IPC、指令與自動化流程未變更 |
...
| Lifestream | 第一輪完成 | 2.5.3.3；完成主頁籤、一般設定、跨資料中心、通訊錄、移動、角色選擇、服務帳號、指令建議、房屋編輯與進度浮層；`Lang.cs` 功能比對、指令 token 與傳送流程未變更 |
