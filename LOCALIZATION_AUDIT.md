...
| Bossmod Reborn | 已完成 | 7.3.8.5；完成首領模組／雷達、技能調整、自動循環、AI、區域自動化、策略／預設／規劃及重播管理／時間軸／分析的一般使用者介面；戰鬥模組機制提示、技能／狀態／ID、IPC、功能流程與純 Debug 診斷保持原樣 |
| vnavmesh | 已完成 | 1.1.2.3；完成主要設定、DTR、路徑點、卡住判定、建置核心與主分頁；另修正台服 7.3 月面 phase 9 客製路徑。進階碰撞、場景及導航網格純除錯資料依翻譯邊界保留英文 |
