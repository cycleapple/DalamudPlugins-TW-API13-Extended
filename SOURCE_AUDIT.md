...
| AntiAfkKick | `NightmareXIV/AntiAfkKick` | `7a0ebaa8` | 2025-08-07 | 已確認 API13 |
| AutoRetainer | `PunishXIV/AutoRetainer` | `f04642ff` | 2025-12-12 | 已確認 API13 |
| Saucy | `PunishXIV/Saucy` | `8e8d5949` | 2025-08-15 | 已確認 API13 |
| NoClippy | `UnknownX7/NoClippy` | `d32ae7af` | 2025-08-09 | API 由建置產生，待編譯確認 |
...
| Pixel Perfect | `Haplo064/PixelPerfect` | `b371fe07` | 2025-08-07 | API 由建置產生，待編譯確認 |
...
| Price Insight | `Kouzukii/ffxiv-priceinsight` | `3c1c16d7` | 2025-08-07 | API 由建置產生，待編譯確認 |
