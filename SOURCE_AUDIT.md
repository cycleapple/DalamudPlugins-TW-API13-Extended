...
| Wrath Combo | `MeowZWR/WrathCombo` | `3b968ca32` | 2025-08-05 | `cycleapple/WrathCombo@0aca93d37` 保留 API13 戰鬥邏輯，參考 `1.0.1.20-cn` 與 `1.0.4.19-cn` 的在地化資源補齊功能清單及職業設定 zh-TW；Release 建置 3 個既有警告、0 錯誤，發布 1.0.1.21。12 月節點雖仍標 API13，但已使用新版 Dalamud 型別，不相容台服 API13 |
...
| Lifestream | `NightmareXIV/Lifestream` | API13 相容節點 | 2025 | `cycleapple/Lifestream@da828c5` 依照台服 `World.csv` 修正世界 ID `4028–4035` 的名稱對照，並處理中文／英文世界名解析、巴哈姆特歸入陸行鳥及 Materia 誤列；API13 Release 建置 32 個既有警告、0 錯誤，發布 2.5.3.7 |
...
| Ice's Cosmic Exploration | `LeontopodiumNivale14/Ices-Cosmic-Exploration` | `f3b7a696c9` | 2025-12-15 | `cycleapple/Ices-Cosmic-Exploration@c32c6d2` 保留 ECommons、`DataId` 與 `Player.JobId` 台服 API13 修正並完成一般使用者介面 zh-TW；15 個既有 SDK／nullable／unused 警告、0 錯誤，發布 0.0.73.42 |
...
| XIV 藏寶圖工具小幫手 | `cycleapple/xiv-party-treasure-helper` | `aaa94f7` | 2026-04-27 | 自有 API12 專案；`cycleapple/xiv-party-treasure-helper@9ebfc4a` 保留 API13 移植與 zh-TW 介面，新增可自訂座標訊息聊天頻道指令，0 警告、0 錯誤；發布 0.1.9.3 |
